      ...
      .then((data) => {
        ...
        data.forEach((user) => {          
          ...
          row.innerHTML = `
            ...
            <td class="text-center" >${user.id_fkCategoria}</td>
            <td class="text-center" >${user.nombre_producto}</td>
            ...
            <td class="text-center columna-operacion-editar"> 
                <a href="actualizarProducto.html?id=${user.id_producto}">
                    <img src="../img/editar.png" alt="editar" class="icono-tabla icono-editar" 
                    data-user-id="${user.id_producto}">
                </a>
            </td>            
